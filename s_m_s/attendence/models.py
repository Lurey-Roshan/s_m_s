...
from adademic.models import ClassRegistration,
from student.models import EnrolledStudent

class AttendenceManager(models.Manager):
	def create_attendence(self, std_class,std_roll):
